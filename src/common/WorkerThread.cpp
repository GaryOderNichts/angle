...
#if !defined(ANGLE_STD_ASYNC_WORKERS) && !defined(ANGLE_ENABLE_WINDOWS_UWP) && !defined(__WIIU__)
...
#if defined(ANGLE_DELEGATE_WORKERS) && (ANGLE_DELEGATE_WORKERS == ANGLE_ENABLED)
...
#endif
#if defined(ANGLE_STD_ASYNC_WORKERS) && (ANGLE_STD_ASYNC_WORKERS == ANGLE_ENABLED)
